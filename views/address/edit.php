            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="address" name="address"
                           value="<?= $address['address'] ?>" placeholder="1234 Main St" required="">
                ...
                <div class="col-md-5">
                    ...
                    <input class="form-control" id="country" name="country" value="<?= $address['country'] ?>"
                           required="">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" id="city" name="city" required="" value="<?= $address['city'] ?>">
                    <?php if (!empty($errors['address'])): ?>
                        <div id="nameHelp" class="form-text error"><?= $errors['address']; ?></div>
                    <?php endif; ?>
                </div>
